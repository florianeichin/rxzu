...
```shell
yarn add ngx-diagrams
```

```shell
npm install ngx-diagrams
```
...
<div class="link-list">
  <a class="link-item" href="https://github.com/Vonage/ngx-diagrams" target="_blank">
  ...
  <a class="link-item" href="https://gitter.im/ngx-diagrams/community" target="_blank">
